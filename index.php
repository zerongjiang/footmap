...
$facebook = new Facebook(array(
  'appId'  => '218834121562272',
  'secret' => '30c280b2d9d471bb47be0c229afa38d2',
));
...
<script type="text/javascript">window.location="<?php echo $loginUrl?>"</script>
<?php }?>
...
<script type="text/javascript">
	...
	<div id="header">
		...
		<div id="username"><?php echo $user_profile['name'];?><span id="status">on the road</span></div>
		<div id="searchbox">
		<input id="search" autocomplete="off" value="Search">
...
<div id="mypublisher">
<div class="toolbar">
	<div id="backstep"><a title="Back" class="btn" href="javascript:void(0)">↺</a></div>
	<div id="post"><a title="Post" class="btn" href="javascript:void(0)">Post</a></div>
	<div id='saveas'><a title="Save Map" class="btn" href='' target='_blank'>Save Map</a></div>
	<div id="fselector"><a title="选择@好友" class="btn" href="javascript:void(0)">选择@好友</a></div>

</div>
<div id="weibostatus"><textarea><?php echo $user_profile['name'];?></textarea></div>
<div id="renderedimg"></div>
</div>

<div id="step1">
	<div class="toolbar">
		<div class="labels">Map Color:</div>
		<div id="mapcolorpicker" class="mycolorpicker" title="Momo"><div></div></div>
		<div id="rainbow" title="Colorful"></div>
		<div id="colorthemes"></div>
		<div class="labels">Background Color:</div>
		<div id="bgcolorpicker" class="mycolorpicker" title="Background Color Picker"><div></div></div>
		<div id="submit"><a class="btn" href="javascript:void(0)">Preview</a></div>
	</div>
		<div class="clear"></div>
	<div id="preview">
	<div id="svgdiv">
...
$('#submit').click(function(){
	...
	$.post("svg.php",{"footmap":myfoot,"svgbgcolor":svgbgcolor,"msg":msg},function(data){
		...
		wbstatus += " has been to "+Object.keys(myfoot).length+" places！";
...
$('#search').bind("keyup", function(e){
	setTimeout(function(){
		...
		if(num_result == 0){
			$('#result').html("couldn't find your place ... T_T");
		}
